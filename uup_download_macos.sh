...
aria2c --no-conf --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=394ef0a3-02d8-498d-bc30-f77f303f1641&pack=zh-cn&edition=corecountryspecific&aria2=2"
if [ $? != 0 ]; then
